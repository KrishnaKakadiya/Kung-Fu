        ...
        <nav  class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="paid.html"><i class="fa fa-bolt "></i>Paid Stuff </a>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-sitemap "></i>Levels of Classes <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="table.html"><i class="fa fa-cogs "></i>Intermediate Levels Class</a>
                            </li>
                             <li>
                                <a href="table.html"><i class="fa fa-bullhorn "></i>Beginner Level Class</a>
                            </li>
                            <li>
                                <a href="table.html"><i class="fa fa-dashcube"></i>Advanced Level Class</a>
                            </li>
                        </ul>
                    </li>
